...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="<?php echo base_url('assets/css/bootstrap.min.cs'); ?>s" rel="stylesheet">
    ...
    <link href="https://getbootstrap.com/docs/3.4/examples/carousel/carousel.css" rel="stylesheet">
  </head>
<!-- NAVBAR
================================================== -->
  <body>
        ...
        <nav class="navbar navbar-inverse navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="<?php echo base_url('users'); ?>">HACO</a>
            </div>
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                <li class="active"><a href="<?php echo base_url('users'); ?>">Home</a></li>
                <li><a href="<?php echo base_url('users/about'); ?>">About</a></li>
                <li><a href="<?php echo base_url('users/contact'); ?>">Contact</a></li>
                <li><a href="<?php echo base_url('users/projects'); ?>">Projects</a></li>
                <li class="dropdown">
